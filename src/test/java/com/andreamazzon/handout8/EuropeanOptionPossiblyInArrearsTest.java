...
import com.andreamazzon.handout7.InterestRatesProductsInArrears;
 ...
 * test class com.andreamazzon.handout7.ConvexityAdjustmentsTests and the
 * methods in com.andreamazzon.handout7.InterestRateProductsInArrears,
 * respectively.
 *
...
public class EuropeanOptionPossiblyInArrearsTest {
	...
	public void testFloater() {
		...
		System.out.println(
				"Price of the floater with the new implementation: " + FORMATTERREAL4.format(priceOfTheFloater));
		System.out.println();
		...
		System.out.println("Price of the convexity adjustment: "
				+ FORMATTERREAL4.format(priceOfTheFloaterInArrears - priceOfTheFloater));
		System.out.println();

		// look at "Solution to exercise 1.pdf" in com.andreamazzon.handout7
	...
	public void testCaplet() {
		...
		System.out
				.println("Price of the caplet with the new implementation: " + FORMATTERREAL4.format(priceOfTheCaplet));
		System.out.println();
		...
		final double priceOfTheCapletWithOldImplementation = InterestRatesProductsInArrears
		...
		final double priceOfTheCapletInArrearsWithOldImplementation = InterestRatesProductsInArrears
