...
public class ExchangeOptionTests {
	...
	@Test
	public void exchangeOptionTest() throws CalculationException {
		...
		for (int correlationIndex = 1; correlationIndex <= 10; correlationIndex++) {
			...
			final LIBORModelMonteCarloSimulationModel newLiborMarketModel = LIBORMarketModelConstructionWithAddedClone
