...
/**
 * This is a test class, testing if the swap rate computed by the class
 * SwapWithoutFinmath is such that the value of the swap contract associated to
 * the computed swap rate is zero.
 *
 * @author Andrea Mazzon
 */
public class SwapWithoutFinmathTest {
	...
	public void testSwapRate() {
		...
		/*
		 * We test if this value is zero, with a tolerance equal to the machine
		 * precision
		 */
