 ...
 * a floater under the Black model. Note that the computation of the convexity
 * adjustment and consequently of the price in arrears is implemented in the
 * parent, abstract class EuropeanOptionPossiblyInArrears: these quantities can
 * be computed once the value of the classical price as a function of the
 * initial value of the Libor is known, see the derivation in "Solution to
 * exercise 2" in com.andreamazzon.exercise2.
 *
...
public class FloaterWithBlack extends EuropeanOptionPossiblyInArrears {
	...
	public double getValueInClassicUnits(double initialValueLibor) {
		 ...
		 * derivation in "Solution to exercise 2". In order to do that, we have to
		 * express it as a function of the initial value of the Libor.
		 */
