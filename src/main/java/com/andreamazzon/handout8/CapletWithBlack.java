 ...
 * a Caplet under the Black model. Note that the computation of the convexity
...
public class CapletWithBlack extends EuropeanOptionPossiblyInArrears {
	...
	public double getValueInClassicUnits(double initialValueLibor) {
		// see formula (78) at page 167 of the script
		return getNotional() * getSecondBond() * getTimeInterval() * AnalyticFormulas
				.blackScholesOptionValue(initialValueLibor, 0, getLiborVolatility(), getFirstTime(), strike);
	}
}