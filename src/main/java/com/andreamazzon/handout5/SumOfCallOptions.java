 ...
 *
 */
public class SumOfCallOptions extends AbstractAssetMonteCarloProduct {
	 ...
	 * are (T_2-T_1)P(T_2;0) and (T_3-T_2)P(T_3;0)
	 */
	 ...
	 */
	public SumOfCallOptions(double firstMaturity, double secondMaturity, double firstStrike, double secondStrike,
	...
	public RandomVariable getValue(double evaluationTime, AssetModelMonteCarloSimulationModel model)
		...
		/*
		 * We multiply the payoff of the second option by a constant ((T_3-T_2)P(T_3;0)
		 * for a cap)
		 */
